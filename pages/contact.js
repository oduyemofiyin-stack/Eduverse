            ...
            content:(
              <div style={{display:'flex', flexDirection:'column', gap:'0.4rem'}}>
                <a href="https://www.linkedin.com/in/oduye-mofiyin-5ab370384" target="_blank" rel="noreferrer"
                  style={{fontSize:'0.84rem', color:'#7a80a0', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', transition:'color 0.2s'}}
                  onMouseEnter={e => e.currentTarget.style.color='var(--text)'}
                  onMouseLeave={e => e.currentTarget.style.color='#7a80a0'}
                >
