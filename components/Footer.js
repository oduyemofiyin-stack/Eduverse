        ...
        <div className="footer-grid" style={{
          ...
          <div style={{minWidth:'220px'}}>
            ...
            <p style={{fontSize:'0.82rem', color:'var(--muted)', lineHeight:'1.7', marginBottom:'1rem', maxWidth:'320px'}}>
              World-class courses, real video lessons, reading materials, and free certificates which is completely free forever.
            </p>
          ...
          <div>
            ...
            {['Courses', 'Paths', 'Search', 'Wishlist', 'My Learning', 'Flashcards'].map(link => (
