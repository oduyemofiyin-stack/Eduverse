...
export default function Footer() {
  ...
  const linkStyle = {
    ...
    transition: 'color 0.2s ease, transform 0.2s ease', textAlign: 'left', display: 'block',
  };
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
        <div className="footer-grid" style={{
          ...
          {/* QUICK LINKS */}
          <div>
            <h4 className="eyebrow" style={{ marginBottom: '0.8rem' }}>Learn</h4>
          ...
          {/* COMPANY */}
          <div>
            <h4 className="eyebrow" style={{ marginBottom: '0.8rem' }}>Company</h4>
          ...
          {/* SUPPORT */}
          <div>
            <h4 className="eyebrow" style={{ marginBottom: '0.8rem' }}>Support</h4>
            <p style={{ fontSize: '0.82rem', color: 'var(--muted)', lineHeight: '1.8' }}>
              <span style={{ color: 'var(--text)' }}>Email:</span><br />
              <a href="mailto:Oduyemofiyin@gmail.com" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Oduyemofiyin@gmail.com</a><br />
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.76rem', color: 'var(--muted)' }}>
            &copy; 2026 <span style={{ color: 'var(--gold)' }}>Eduverse Academy Ltd</span> &middot; Lagos, Nigeria &middot; All courses free forever
          </p>
          <p style={{
            fontSize: '0.76rem', color: 'var(--muted)',
            background: 'var(--surface2)', padding: '0.2rem 0.8rem',
            borderRadius: 'var(--radius-full)', fontStyle: 'italic',
          }}>
